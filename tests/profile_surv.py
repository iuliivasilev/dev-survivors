...
def get_samples():
    X, y, features, categ, sch_nan = load_onk_dataset()
...
def profile_tree():
    ...
    params = {"criterion": "peto", "depth": 10, "min_samples_leaf": 1, "signif": 0.05, "n_jobs": 2}
    ...
    stats.print_stats()
    stats.dump_stats('profile_reports/ONK/tree_output_2.pstats')
